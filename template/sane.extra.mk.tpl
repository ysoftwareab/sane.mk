...
# Header
sed -n '1,/^# BEGIN # includes$/p' "${SANE_MK_ROOT}/template/sane.extra.mk"
...
done <"${SANE_MK_ROOT}/template/sane.extra.mk"

# Footer
sed -n '/^# END # includes$/,$p' "${SANE_MK_ROOT}/template/sane.extra.mk"
